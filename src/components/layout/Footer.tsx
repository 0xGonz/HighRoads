        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/how-it-works" className="text-gray-300 hover:text-white hover:underline transition-colors">
                  How It Works
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/apply" className="text-gray-300 hover:text-white hover:underline transition-colors">
                  Apply Now
                </Link>
              </li>
            </ul>
            ...
            <ul className="space-y-3">
              <li>
                ...
                >
                  ...
                  <span>contact@highroadtech.com</span>
                </a>
              </li>
